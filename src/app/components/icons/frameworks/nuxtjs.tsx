interface NuxtjsIconProperty {
  height: string;
  width: string;
}

type NuxtjsIconProps = {
  property: NuxtjsIconProperty;
};

export const NuxtjsIcon = ({ property }: NuxtjsIconProps) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={property.width ? property.width : '1.53em'}
