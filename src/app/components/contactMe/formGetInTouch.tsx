      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        <div className="grid lg:grid-cols-2 lg:gap-3">
          <div className="mb-2">
            <label
              htmlFor="name"
              className="text-slate-900 dark:text-slate-100 block mb-1">
              Full Name
            </label>
            <input
              defaultValue={''}
        ...
        <div className="mb-2">
          ...
          />
          {errors.message && (
            <span className="text-sm text-red-500">Please enter a message</span>
          )}
        </div>
        <button
          type="submit"
          className="bg-blue-500 text-white w-full px-4 py-3 rounded-md hover:bg-blue-600 transition duration-100 ease-in">
          Send Message
        </button>
      </form>
    </>
